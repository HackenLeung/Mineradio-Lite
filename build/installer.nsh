...
!macro customInstall
  ...
  ${IfNot} ${Errors}
    FileWrite $0 "Mineradio Lite install root$\r$\n"
    FileWrite $0 "appId=com.mineradio.lite$\r$\n"
    FileClose $0
  ${EndIf}
!macroend
...
Function MineradioUseFirstAvailableInstallDir
  ...
  StrCpy $INSTDIR "C:\Mineradio Lite"
  Return

  driveD:
    StrCpy $INSTDIR "D:\Mineradio Lite"
    Return
  driveE:
    StrCpy $INSTDIR "E:\Mineradio Lite"
    Return
  driveF:
    StrCpy $INSTDIR "F:\Mineradio Lite"
    Return
  driveG:
    StrCpy $INSTDIR "G:\Mineradio Lite"
    Return
  driveH:
    StrCpy $INSTDIR "H:\Mineradio Lite"
    Return
  driveI:
    StrCpy $INSTDIR "I:\Mineradio Lite"
    Return
  driveJ:
    StrCpy $INSTDIR "J:\Mineradio Lite"
    Return
  driveK:
    StrCpy $INSTDIR "K:\Mineradio Lite"
    Return
  driveL:
    StrCpy $INSTDIR "L:\Mineradio Lite"
    Return
  driveM:
    StrCpy $INSTDIR "M:\Mineradio Lite"
    Return
  driveN:
    StrCpy $INSTDIR "N:\Mineradio Lite"
    Return
  driveO:
    StrCpy $INSTDIR "O:\Mineradio Lite"
    Return
  driveP:
    StrCpy $INSTDIR "P:\Mineradio Lite"
    Return
  driveQ:
    StrCpy $INSTDIR "Q:\Mineradio Lite"
    Return
  driveR:
    StrCpy $INSTDIR "R:\Mineradio Lite"
    Return
  driveS:
    StrCpy $INSTDIR "S:\Mineradio Lite"
    Return
  driveT:
    StrCpy $INSTDIR "T:\Mineradio Lite"
    Return
  driveU:
    StrCpy $INSTDIR "U:\Mineradio Lite"
    Return
  driveV:
    StrCpy $INSTDIR "V:\Mineradio Lite"
    Return
  driveW:
    StrCpy $INSTDIR "W:\Mineradio Lite"
    Return
  driveX:
    StrCpy $INSTDIR "X:\Mineradio Lite"
    Return
  driveY:
    StrCpy $INSTDIR "Y:\Mineradio Lite"
    Return
  driveZ:
    StrCpy $INSTDIR "Z:\Mineradio Lite"
    Return
FunctionEnd
...
Function MineradioValidateInstallDir
  ...
  ${If} $1 == ":"
    ...
    ${OrIf} $0 == "c"
      ...
      ${AndIf} $3 != "1"
      ${AndIf} $4 != "1"
        MessageBox MB_ICONSTOP|MB_OK "检测到这台电脑还有 D-Z 盘，Mineradio Lite 不安装到 C 盘。请改选 D 盘或其它非 C 盘的 Mineradio Lite 文件夹。$\r$\n$\r$\n如果电脑只有 C 盘，安装器会自动放行 C:\Mineradio Lite。"
        Abort
      ${EndIf}
    ${EndIf}
  ${EndIf}
  ...
  ${If} $0 < 15
  ${OrIf} $1 != "\Mineradio Lite"
  ${AndIf} $1 != "\mineradio lite"
    MessageBox MB_ICONSTOP|MB_OK "安装目录必须是独立的 Mineradio Lite 文件夹。请选择一个上级目录，安装器会自动创建 Mineradio Lite 子文件夹。"
    Abort
  ${EndIf}
  ...
  MessageBox MB_ICONSTOP|MB_OK "为避免卸载时误删其它文件，Mineradio Lite 不能安装到已有文件的非专属目录。请新建或选择一个空的 Mineradio Lite 文件夹。$\r$\n$\r$\n当前路径：$INSTDIR"
  Abort
...
Function MineradioWelcomeShow
  ...
  ${NSD_CreateLabel} 22u 42u 226u 30u "Mineradio Lite 安装"
  Pop $0
  ...
  ${NSD_CreateLabel} 22u 96u 238u 24u "为这台电脑安装 Mineradio Lite。默认安装到 D:\Mineradio Lite，下一步可以自由选择其它位置。"
  Pop $0
...
Function MineradioDirectoryBrowse
  nsDialogs::SelectFolderDialog "选择 Mineradio Lite 安装文件夹" "$INSTDIR"
  Pop $0
  ${If} $0 != error
  ${AndIf} $0 != ""
    Push "$0"
...
Function MineradioDirectoryShow
  ...
  ${NSD_CreateLabel} 22u 122u 238u 12u "默认推荐：D:\Mineradio Lite；选盘符会自动建文件夹。"
  Pop $0
  SendMessage $0 ${WM_SETFONT} $MineradioSmallFont 1
...
Function un.MineradioValidateUninstallDir
  ...
  Pop $1
  ${If} $0 != $1
    MessageBox MB_OK|MB_ICONSTOP "当前卸载路径不是 Mineradio Lite 专属目录，已阻止卸载以避免误删其它文件。$\r$\n$\r$\n当前路径：$INSTDIR$\r$\n安全路径应为：$0"
    SetErrorLevel 2
    Quit
  ${EndIf}
  StrCpy $INSTDIR "$0"
  ...
  Pop $0
  ${If} $0 != "1"
    MessageBox MB_OK|MB_ICONSTOP "无法确认当前目录属于 Mineradio Lite，已阻止卸载以避免误删其它文件。$\r$\n$\r$\n当前路径：$INSTDIR"
    SetErrorLevel 2
    Quit
  ${EndIf}
FunctionEnd
